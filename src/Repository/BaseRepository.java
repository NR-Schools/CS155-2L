...
public abstract class BaseRepository {
    private final String USERNAME = "sql12604574";
    private final String PASSWORD = "tjirB4YRYb";
    ...
    protected Connection createSQLConnection() throws SQLException, ClassNotFoundException  {
        ...
        SetDB.executeUpdate("USE sql12604574"); // Change database name if necessary
